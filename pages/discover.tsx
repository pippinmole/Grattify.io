    ...
    return (
        <Layout>
            ...
            <div className="flex flex-wrap -m-4">
                {posts.map((post) => <PostTile post={post} key={post._id}></PostTile>)}
            </div>
        </Layout>
    )
}

function PostTile({post}: {post: IPost}) {
    return (
            ...
            <div
                ...
                <div className="p-6"><h2
                    ...
                    <div className="flex items-center flex-wrap ">
                        <Link className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0" href={`/post/${post._id}`}>
                            Read More
